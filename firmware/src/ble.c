 ...
 * removed in v5.5). v5.14 removed the v5 MACRO_LIST/MACRO_RW macro-store
 * characteristics for good: they hung every v5.x/v5.12/v5.13 build on
 * hardware and are not coming back; macro.c stays in the tree as a
 * reference but is excluded from the build (see DEBUG_NOTES.md v5.14).
 * See PROTOCOL.md.
 */
 ...
 *
 * nus_svc attribute layout (v5.14: the v5 macro characteristics are gone
 * for good):
